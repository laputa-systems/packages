...
export let upstream_sources = [
  {source: p"files/cacert.pem", kind: "auto", architectures: ["all"], checksums: [{arch: "all", sha256: "b6e66569cc3d438dd5abe514d0df50005d570bfc96c14dca8f768d020cb96171"}]},
  {source: p"files/update-certdata.xsh", kind: "auto", architectures: ["all"], checksums: [{arch: "all", sha256: "176ed1182db55c90455a55bf883a1985a741840b405717bd32409d7b7bb23c30"}]}
]
