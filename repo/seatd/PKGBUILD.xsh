...
""",
  ...
  fs.write(p"linux/major.h", """#pragma once
""")?
}
...
export proc build(dest: Path) [fs, process, env, error] {
  ...
  env {
    ...
    run $muon "setup" "-Dprefix=/usr" "-Dlibdir=lib" "-Ddefault_library=shared" "-Dwerror=false" "-Dlibseat-logind=disabled" "-Dlibseat-seatd=enabled" "-Dlibseat-builtin=disabled" "-Dserver=enabled" "-Dexamples=disabled" "-Dman-pages=disabled" "build" ?
